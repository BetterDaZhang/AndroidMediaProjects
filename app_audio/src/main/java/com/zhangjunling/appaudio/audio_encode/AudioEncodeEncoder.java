...
public class AudioEncodeEncoder {
	...
	public AudioEncodeEncoder(OutputAACDelegate outputAACDelegate, int sampleRate, int channels, int bitRate) throws IOException {
	...
	public void fireAudio(byte[] data, int len) {
		...
		if (inputBufferIndex >= 0) {
			...
			mediaCodec.queueInputBuffer(inputBufferIndex, 0, len, System.nanoTime() / 1000, 0);
		}
